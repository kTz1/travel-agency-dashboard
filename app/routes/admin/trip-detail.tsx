...
const TripDetail = ({ loaderData }: Route.ComponentProps) => {
  ...
  // Parse the trip data from the loaderData
  ...
  // Create an array of visit time and weather info
  const visitTimeAndWeatherInfo = [
    { title: "Bes Time to Visit: ", items: bestTimeToVisit },
    { title: "Wether: ", items: weatherInfo },
  ];
  ...
  return (
    <main className="travel-detail wrapper">
      ...
      <section className="container wrapper-md">
        ...
        {/* Itinerary */}
        <h2 className="p-40-semibold text-dark-100">Itinerary</h2>
